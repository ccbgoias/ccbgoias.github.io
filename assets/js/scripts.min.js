...
;(function () {
  ...
  const Config = { Link: '.js-share', Width: 500, Height: 500 }
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker
      ...
      .then((registration) => {
        console.log(
          'Service Worker registrado em min com sucesso:',
          registration
        )
      })
      .catch((error) => {
        console.error('Falha ao registrar o Service Worker min:', error)
      })
  })
}
